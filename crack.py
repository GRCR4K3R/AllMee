...
class Main:
	...
	def email(self):
		x = 111
		xx = 999
		nama = input(" [?] masukan nama (cth: Reza): ")
		nama = nama.replace(" ", "")
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Facebook  : https://facebook.com/reza123dcm")
		print(" [*] Instagram : https://instagram.com/GakPunya:)")
		print(" [*] YouTube   : https://youtube.com/Reja Gaming")
		exit(" [*] GitHub    : https://github.com/GRCR4K3R")
	else:
		Main()
